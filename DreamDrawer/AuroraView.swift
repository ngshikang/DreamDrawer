                        ...
                        ZStack {
                            ForEach(animator.circles) { circle in
                                MovingCircle(originOffset: circle.position)
                                    ...
                                    .clipShape(Rectangle()) // Ensure the shape fits within the defined rectangle
                            }
                            .blur(radius: AnimationProperties.blurRadius)
                        }
                        
                    }
                    .frame(width: geometry.size.width, height: geometry.size.height) // Set the bounds for the Aurora effect
